...
Request collections for each API, plus a shared environment file, are at
<https://developer.vippsmobilepay.com/docs/knowledge-base/api-collections.md>. Do not put production keys in a
